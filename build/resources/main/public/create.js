...
const create = (function(){
  ...
  function createLi(li,ul,id) {
    ...
    row.innerHTML =
    `<span class="name_column"><strong>${li.name}</strong></span>
     <span class="calories_column"><strong>${li.calories}</strong> kcal</span>
     <span class="date_column"><strong>${date}</strong></span>`
    return row
  }
